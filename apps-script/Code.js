/**
 * ═══════════════════════════════════════════════════════════════
 *  INVENTORY TRACKER — Google Apps Script Backend  (v1.7.0-codex)
...
function doGet(e) {
  return jsonOut({ ok: true, message: 'Inventory Tracker backend is running. v1.7.0-codex' });
}
...
function setup() {
  ...
  Logger.log('✅ Setup complete (v1.7.0-codex). Daily EOD trigger at ' + hour + ':00.');
}
